...
//The code that controls the stats came from https://assetstore.unity.com/packages/tools/gui/item-inventory-system-45568#description and has been modified to interact with Emerald AI
    ...
    public class StatsHandler : MonoBehaviour, IJsonSerializable
    {
       ...
       /* private void OnGUI()
        ...
        private void Update()
        {
            ...
            //add code so that if player dies current death total is increased
        }
